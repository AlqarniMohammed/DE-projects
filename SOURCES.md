...
- [`original-prompt.md`](sources/original-prompt.md) + [`original-outcoms.md`](sources/original-outcoms.md) — the old 30-project prompt and its full output
- [`de-master-guide-2026.md`](sources/de-master-guide-2026.md) — the earlier tool guide (audited above)
- [`de-lifecycle-refrence.md`](sources/de-lifecycle-refrence.md) — DEA course Section-1 notes reorganized by project lifecycle (used as Phase 0 reading)
